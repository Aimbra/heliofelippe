...
function extra_load_scripts_styles(){
	...
	wp_localize_script( 'extra-scripts', 'EXTRA', array(
		...
		'your_rating'                  => esc_html__( 'Seu voto:', 'extra' ),
		...
		'error'                        => esc_html__( 'Ocorreu algum problema e não sei o que é. Tente novamente...!', 'extra' ),
		'contact_error_name_required'  => esc_html__( 'O campo nome não pode estar vazio.', 'extra' ),
		'contact_error_email_required' => esc_html__( 'O campo e-mail não pode estar vazio.', 'extra' ),
