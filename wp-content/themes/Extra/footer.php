<?php $footer_above_ad = extra_display_ad( 'footer_above', false ); ?>
	...
	<footer id="footer" class="<?php extra_footer_classes(); ?>">
		...
		<div id="footer-bottom">
			<div class="container">
				...
				<!-- Footer Info -->
				<p id="footer-info"><?php printf( et_get_safe_localization( __( 'Projetado por %1$s | Distribuído por %2$s', 'extra' ) ), '<a href="http://www.aimbra.com.br" title="Sistemas robustos para seus negócios">Aimbra</a>', '<a href="http://www.wordpress.org">WordPress</a>' ); ?></p>
	...
	<?php if ( 'on' == et_get_option( 'extra_back_to_top' ) ) { ?>
		<span title="<?php esc_attr_e( 'Ir para o topo', 'extra' ); ?>" id="back_to_top"></span>
	<?php } ?>
